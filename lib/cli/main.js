...
var hthcorenode = require('..');
var utils = require('../utils');

function main(servicesPath, additionalServices) {
  /* jshint maxstatements: 100 */

  var version = hthcorenode.version;
  var create = hthcorenode.scaffold.create;
  var add = hthcorenode.scaffold.add;
  var start = hthcorenode.scaffold.start;
  var remove = hthcorenode.scaffold.remove;
  var callMethod = hthcorenode.scaffold.callMethod;
  var findConfig = hthcorenode.scaffold.findConfig;
  var defaultConfig = hthcorenode.scaffold.defaultConfig;
  ...
  program
    ...
    .option('-d, --datadir <dir>', 'Specify the HTH database directory')
  ...
  program
    ...
    .option('-c, --config <dir>', 'Specify the directory with hthcorenode Node configuration')
    .option('-d, --daemon', 'Make hthcorenode-node a daemon (running in the background)')
    .action(function(cmd){
      if (cmd.config) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `hthcorenode-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ hthcorenode-node add wallet-service');
      console.log('    $ hthcorenode-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ hthcorenode-node remove wallet-service');
      console.log('    $ hthcorenode-node remove insight-api');
      console.log();
    });
