...
Hth.prototype._parseDashConf = function(configPath) {
  var options = {};
...
Hth.prototype._checkConfigIndexes = function(spawnConfig, node) {
  ...
  $.checkState(
    ...
    '"server" option is required to communicate to hthd from dashcore. ' +
...
Hth.prototype._stopSpawnedDash = function(callback) {
  var self = this;
  var spawnOptions = this.options.spawn;
